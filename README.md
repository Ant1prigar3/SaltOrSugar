# SaltOrSugar - игра, созданная средствами Pygame и Pymunk, суть которой заключается в наполнении кружки сахаром, путем рисования объектов (рисуются они с помощью мышки).
